    ...
    Types: PayloadTypes<PayloadAttributes = EthPayloadAttributes, ExecutionData = ExecutionData>,
{
    ...
    fn ensure_well_formed_attributes(
        ...
        match version {
            ...
            // reth-v2.4.1 migration: v2.4.1 adds `EngineApiMessageVersion::V6`, which did not
            // exist when 0G wrote this match. It is rejected for the same reason 0G rejects V5.
            EngineApiMessageVersion::V6 => return Err(EngineObjectValidationError::UnsupportedFork),
        }
